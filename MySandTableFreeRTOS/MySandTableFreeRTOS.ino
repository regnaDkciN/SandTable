...
volatile bool         RandomSeedChanged = false;  // 'true' when random seed has been change.
...
//  'C' (CUR SHAPE)   Gets the invocation string of the currentl shape.
/////////////////////////////////////////////////////////////////////////////////
...
void StartShape(const char *pFmt, ...)
{
    ...
    if (LOG_INFO)
    {
        ...
        // Save the string.  No need to do this withina critical section since
